...
// Определяет положение курсора при нажатии правой кнопки мыши и, если нажатие произошло в пределах карты, указывает новую позицию точки и вызывает draw для обновления картинки.
...
//виджет для отображения градиента уровней силы сигнала.
